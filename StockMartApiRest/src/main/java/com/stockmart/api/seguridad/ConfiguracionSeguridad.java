package com.stockmart.api.seguridad;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf(csrf -> csrf.disable())// 1. Desactiva CSRF (porque Angular no lo maneja por defecto)
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/inventario-app/auth/login","/inventario-app/auth/registro","/public/**", "/swagger-ui/**", "/v3/api-docs/**").permitAll(). //3. Rutas publicas
