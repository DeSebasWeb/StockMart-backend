...
public class VentaGestionServicio implements IVentaGestionServicio {
    ...
    @Autowired
    public VentaGestionServicio(EstadoServicio estadoServicio, ProductoLecturaServicio productoLecturaServicio, VentaRepositorio ventaRepositorio, VentaConsultaServicio ventaConsultaServicio, VendedorGestionServicio vendedorGestionServicio, DetalleVentaGestionServicio detalleVentaGestionServicio, ProductoGestionServicio productoGestionServicio) {
